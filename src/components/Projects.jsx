...
const projects = [
  ...
  },
  {
    id: 5,
    title: 'ParkX 🚗',
    subtitle: 'iOS Smart Parking Application',
    githubUrl: 'https://github.com/Jaswanth-K1210/ParkingApp-SwiftUI',
    desc: 'A native iOS application built with SwiftUI to streamline the process of finding, reserving, and managing parking spaces. Implements a clean, modern user interface combined with real-time availability tracking and seamless booking modules.',
    arch: ['Swift', 'SwiftUI', 'iOS SDK', 'Xcode']
  },
  {
    id: 6,
